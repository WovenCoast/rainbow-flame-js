...
module.exports = {
  ...
  async exec(client, message, args) {
    ...
    return message.channel.send(`:arrow_forward: Now Playing: ${client.util.parseSongName(song)}, playhead at ${client.util.convertDuration(message.guild.music.duration)}`)
  }
}