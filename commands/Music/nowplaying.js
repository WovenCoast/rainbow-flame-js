...
module.exports = {
  ...
  async exec(client, message, args) {
    ...
    return message.channel.send(`:arrow_forward: Now Playing: ${parseSongName(song.title, song.author)} requested by **${song.requestedBy}**: ${client.util.convertDuration(message.guild.music.duration)} / ${client.util.convertDuration(message.guild.music.songs[0].duration)}`)
  }
}
