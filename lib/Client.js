...
class Client extends Discord.Client {
  ...
  constructor(opts, discordOpts) {
    ...
    /**
     * Please stop spamming Hapi Duc
     * @type {Map<string, Date>}
     */
    this.levelCooldown = new Map();
    /**
     ...
     */
    this.db = {
      guild: new DBClient(this, this.schemas.guild, {
        uri: "sqlite://.data/guilds.sqlite",
        namespace: "guild",
      }),
      user: new DBClient(this, this.schemas.user, {
        uri: "sqlite://.data/users.sqlite",
        namespace: "user",
      }),
      member: new DBClient(this, this.schemas.member, {
        uri: "sqlite://.data/members.sqlite",
        namespace: "member",
      }),
      client: new DBClient(this, this.schemas.client, {
        uri: "sqlite://.data/client.sqlite",
        namespace: "client",
      }),
    };
    /**
